...
const projects = [
  {
    id: 1,
    title: "ChainPaye",
    description: "A high-performance crypto payment gateway enabling seamless on/off-ramps for local fiat currencies globally.",
  ...
  },
  {
    id: 2,
    title: "FortiChain",
    description: "An advanced security auditing platform dedicated to vulnerability research and project-wide threat mitigation.",
  ...
  },
  {
    id: 3,
    title: "PayMesh",
    description: "A decentralized ecosystem for instant multi-party payment distribution and community-driven crowdfunding.",
  ...
  },
  {
    id: 5,
    title: "EventHub",
    description: "A simple way to create events and sell tickets online, making it easy for people to organize gatherings and manage their guests.",
  ...
  },
  {
    id: 6,
    title: "FineAce",
    description: "A secure Web3 escrow protocol engineered for precise fund management and programmable distribution.",
  ...
  },
  {
    ...
    description: "A dynamic, real-time quiz platform designed for interactive learning and high-engagement user challenges.",
  ...
  return (
    <section id="work" className="gallery py-32 container">
      <div className="mb-24 animate-in">
        <h2 className="title-gradient text-5xl font-display">Selected Proof of Work</h2>
        <p className="text-text-dim text-lg">A curated collection of digital products built with performance and precision.</p>
      </div>
              ...
              <div className="flex flex-col items-start lg:items-end gap-6 text-left lg:text-right">
                <div className="flex flex-wrap lg:justify-end gap-2">
                  {project.tags.map(tag => (
                    <span key={tag} className="text-[10px] px-2.5 py-1 bg-white/[0.03] rounded-full text-text-dim border border-white/5 uppercase tracking-widest">
                      {tag}
                    </span>
                  ))}
                </div>
